...
def student_screen():
    ...
    if show_registration:
        with st.container(border=True):
            ...
            new_name = st.text_input("Enter your name", placeholder='e.g. Anurag Singh')
            ...
            try:
                audio_data = st.audio_input('Record a short phrase like - I am present, My name is Anurag.')
            except Exception:
